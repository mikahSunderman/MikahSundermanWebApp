...
namespace MikahSundermanWebApp.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public EducationsController(MikahSundermanWebAppContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,University,Location,GraduationDate,Major,Minor")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,University,Location,GraduationDate,Major,Minor")] Education education)
        {
            if (id != education.ID)
            {
                return NotFound();
